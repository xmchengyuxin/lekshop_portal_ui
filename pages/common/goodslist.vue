<template>
	<view>
		<waterfallsFlow :list="list" :offset="offset" :idKey="idKey" :imageSrcKey="imageSrcKey" :cols="cols" :imageStyle="imageStyle" :single="single">
			  <!--  #ifdef  MP-WEIXIN -->
			  <!-- 微信小程序自定义内容 -->
			  <view v-for="(item, index) of list" :key="index" slot="slot{{index}}">
				<view class="padding-12">
				  ...
				  <view class="flex  f-w margin-t4">
					  <view class="flex f-a-c f10-size padding-lr5 h-16 b-color-r t-color-r b-radius-2 margin-r8">官方放心购</view>
				  </view>
