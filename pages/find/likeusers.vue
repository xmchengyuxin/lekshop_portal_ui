<template>
	<view class="contain ">
		...
		<view v-for="(item,index) in list" class="bg-color-w b-radius-5 padding-10 flex margin-b12">
			<view class="flex f-s-0 w-50 h-50 b-radius bg-img margin-r12" :style="item.walkMemberHeadImg | bgimg(300)+''"></view>
			<view class="flex flex-1 f-c f-j-c">
				<view @click="go('/pages/find/user?id='+item.walkMemberId)" class="flex">{{item.walkMemberName}}</view>
