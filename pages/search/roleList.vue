	...
	<view class="contain">
		<view class="fixed-top box-c bg-color-f7" :style="{ 'padding-top': top + 'px' }">
			<view class=" flex h-44 flex ">
				...
				<view  @click="go('/pages/index/cateRole',2)"  class="flex f-a-c f-j-c van-icon van-icon-cate margin-l12 f20-size"></view>
		...
		<view class="padding-lr10">
			<goodslist class="margin-t12" :isRoleGoods="true" :sortType="sortType" :list="list"></goodslist>
		</view>
